...
/**
 * This class is the Table in the view to display the results of the similarity-search to the user.
 * 
 * @author Benjamin Birner
 *
 */
public class SimilarityJTable extends JInternalFrame {
	 ...
	 */
	public SimilarityJTable(SimilarityModel model, MainFrame frame, String title) {
	    ...
	    final TableRowSorter<DefaultTableModel> rowSorter = new TableRowSorter<>(model); 
